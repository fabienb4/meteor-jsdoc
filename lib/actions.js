...
Actions.prototype.build = function() {
  ...
  if (self.config.preamble) {
    var jsString = "DocsPreamble = \"" + self.config.preamble + "\";";
    jsString = "// This file is automatically generated by meteor-jsdoc. Regenerate it with 'meteor-jsdoc build'\n" + jsString;
    var docsPreambleFilename = self.config.docsPath + "/client/data/docs-preamble.js";
    fs.writeFileSync(docsPreambleFilename, jsString);
  }
